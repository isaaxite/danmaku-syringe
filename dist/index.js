(() => {
    ...
    selectingVideoArea(event) {
      ...
      if (!this.currentVideoInfo) {
        for (let i = 0; i < this.videoInfosArr.length; i++) {
          ...
          if (current.startX < event.clientX && current.endX > event.clientX && current.startY < event.clientY && current.endY > event.clientY) {
      ...
      if (this.currentVideoInfo.startX < event.clientX && this.currentVideoInfo.endX > event.clientX && this.currentVideoInfo.startY < event.clientY && this.currentVideoInfo.endY > event.clientY) {
        if (!this.whenIn) {
  ...
  // src/Menu.jsx
  var _tmpl$ = /* @__PURE__ */ template(`<ul><li><button>\u9009\u62E9\u89C6\u9891\u533A\u57DF</button></li><li><button>\u6CE8\u5165\u5F39\u5E55</button></li><li><button>\u6DFB\u52A0\u5F39\u5E55`);
  var Menu = () => {
    ...
    return (() => {
      var _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$2.nextSibling, _el$5 = _el$4.firstChild, _el$6 = _el$4.nextSibling, _el$7 = _el$6.firstChild;
      _el$3.$$click = selectVideoAreahandler;
      _el$5.$$click = insertDanmaku;
      _el$7.$$click = pushDanmaku;
      return _el$;
    })();
  };
  ...
  // src/App.jsx
  var _tmpl$2 = /* @__PURE__ */ template(`<div><div id=video-container><video id=video controls src=./bxuVPiq7g9lTaA.mp4>`);
  var App = () => {
    return (() => {
      var _el$ = _tmpl$2(), _el$2 = _el$.firstChild;
      insert(_el$, createComponent(Menu_default, {}), _el$2);
      return _el$;
    })();
  };
  var App_default = App;
  ...
  // index.jsx
  render(App_default, document.getElementById("root"));
})();
